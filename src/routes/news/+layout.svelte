		...
		<div class="flex flex-col gap-6 tablet:flex-row justify-between px-3 py-3">
			...
			<div class="flex flex-row gap-3 justify-between">
				...
				<button
					...
					class="btn-primary tablet:btn-accent  flex px-2"
				>
					<img
						src={wallet}
						alt="connect wallet"
						class="tablet:border-r-2 tablet:border-r-accent tablet:px-3 tablet:py-2 block"
					/>
					<span class="px-6 sm:px-2 hidden tablet:block">Connect Wallet</span>
				</button>
			</div>
		</div>
